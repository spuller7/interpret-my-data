...
const PageHeader = lazy(() => import('@imd/components/utility/pageHeader'));
const Box = lazy(() => import('@imd/components/utility/box'));
const LayoutWrapper = lazy(() =>
  import('@imd/components/utility/layoutWrapper')
);
const ContentHolder = lazy(() =>
  import('@imd/components/utility/contentHolder')
);
